...
public class UserPreferences implements Listener<PreferenceType>
{
    ...
    private io.github.dsheirer.audio.broadcast.AudioActivityWatchdog mAudioActivityWatchdog;
    private io.github.dsheirer.audio.broadcast.SystemHealthWatchdog mSystemHealthWatchdog;
    ...
    /**
     * Audio activity watchdog preferences
     */
    ...
    /**
     * Returns the live AudioActivityWatchdog instance, set by AudioPlaybackManager on startup.
     */
    public io.github.dsheirer.audio.broadcast.AudioActivityWatchdog getAudioActivityWatchdog()
    {
        return mAudioActivityWatchdog;
    }

    /**
     * Called by AudioPlaybackManager to register the live watchdog instance so the preferences UI can reach it.
     */
    public void setAudioActivityWatchdog(io.github.dsheirer.audio.broadcast.AudioActivityWatchdog watchdog)
    {
        mAudioActivityWatchdog = watchdog;
    }

    /**
     * Returns the live SystemHealthWatchdog instance monitoring tuners and streamers.
     */
    public io.github.dsheirer.audio.broadcast.SystemHealthWatchdog getSystemHealthWatchdog()
    {
        return mSystemHealthWatchdog;
    }

    /**
     * Called during app startup to register the live SystemHealthWatchdog instance.
     */
    public void setSystemHealthWatchdog(io.github.dsheirer.audio.broadcast.SystemHealthWatchdog watchdog)
    {
        mSystemHealthWatchdog = watchdog;
    }
    ...
    private void loadPreferenceTypes()
    {
        ...
        mAudioWatchdogPreference = new AudioWatchdogPreference(this::receive);
    }
